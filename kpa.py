...
helpMessage= """RashiF's protect bot command
 
Use command in group's ☣
❂Set
❂Bot1~6 rename:
❂Comment:
❂Message:
...
❂Wiki..
❂Sayv..
ই͜͜͡This bot create by✍
-> line.me/ti/p/~rsf.22 """

Keyowner= """✍Command set's use to protect group's
➣Auto join:on/off
➣Protect:on/off
➣Namelock:on/off
➣Auto leave:on/off
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"ue2101fb9b105a2341d4d511635a12353"]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thx for add me dont forget no add my owner👇\n\n\nhttp://line.me/ti/p/mEHpAq1ejt",
    "lang":"JP",
    "comment":"Auto like by RashiF",
    "welmsg":"Welcome group somoga betah\n\n\nHave fun in group💁",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#=======================================================
              ...
              if msg.from_ in admin:
                ...
                ks.sendText(msg.to,"⚠⚠⚠⚠⚠")
                kt.sendText(msg.to,"⚠⚠⚠⚠⚠⚠")
                cl.sendText(msg.to,"Semua dah hadir bos'Q")
...
#==================================================================
              ...
              if msg.from_ in admin:
				msg.contentType = 13
				msg.contentMetadata = {'mid': "ue2101fb9b105a2341d4d511635a12353"}
				cl.sendMessage(msg)
...
#==========================================================
 ...
 #=======================================================
            elif "Sayv " in msg.text:
              if msg.from_ in admin:
                 psn = msg.text.replace("Sayv ","")
              ...
              if msg.from_ in admin:
                 ...
                 tts.save('tts.mp3')
                 cl.sendAudio(msg.to, 'tts.mp3')
            elif "Tr-eng " in msg.text:
              if msg.from_ in admin:
                txt = msg.text.replace("Tr-eng ","")
                try:
            ...
            elif "Tr-japan " in msg.text:
              if msg.from_ in admin:
                txt = msg.text.replace("Tr-japan ","")
                try:
                    translator = Translator()
              ...
              if msg.from_ in admin:
                ...
                try:
                    ...
                    cl.sendText(msg.to,A)
                      ...
                      cl.sendText(msg.to,'Error.')
            elif "Tr-idn " in msg.text:
              if msg.from_ in admin:
                txt = msg.text.replace("Tr-idn ","")
                try:
                    translator = Translator()
...
#=================================================================
            elif msg.text in ["Protect:on","protect:hight"]:
              if msg.from_ in admin:
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin:
                if wait["welcomemsg"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"welcome message off\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Protect:off","Protect:low"]:
              if msg.from_ in admin:
...
#========================================
            elif msg.text in ["@join","Join kontol","Join all"]:
              if msg.from_ in admin:
