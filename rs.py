...
cl = LINETCR.LINE()
cl.login(token="EoDI9wLQSgcBXJa8RD63.4HaFUBefOJqDtvewnAeJuW.tIR190cZ3msNO8xiys5wE/mMiqVgOOKziq8c8RAPEos=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EoDqFMz2pXMN2ncomj90.2PshkH9jZu06gbOeQKJtua.8NYE85vd/kbWWwwwA94ert5kMbEccTo6yGtpu7bHRDw=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EoU5EnWvINzApOPdLGB8.i3hnA4/p23TFxB7SF/e5ca.E/nftSYMD2aTMjO+lzgnkNOqjBlozJ/si1P5w54iL9Q=")
ki2.loginResult()
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
                ...
                for i in gid:
                  ...
                  ki2.leaveGroup(i)
                if wait["lang"] == "JP":
                  cl.sendText(msg.to,"Done assist out")
                else:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              #if msg.from_ in admin:
                ki.sendText(msg.to,"Assist1 on!!")
                ki2.sendText(msg.to,"Assist2 on!!")
